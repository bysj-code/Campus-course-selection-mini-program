<template>
  <view class="page_course_schedule diy_table diy_table_tml" id="course_schedule_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/course_schedule/view?" v-show="user_group == '管理员' || $check_action('/course_schedule/table','add') || $check_action('/course_schedule/view','add')">添加</navigator>
		...
		<view class="warp">
			<view class="container">
				<view v-for="(o,i) in list" class="row">
										<view v-if="0 && $check_field('get','course_no')" class="col">
						<view class="view">
                            ...
                            <span>课程编号</span>
								...
								<text>
									{{ o["course_no"] }}
													...
													<view v-if="1 && $check_field('get','course_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>课程名称</span>
                          </view>
                          ...
                          <view class="diy_title" v-if=" false">
                            <span>封面</span>
								...
								<img :src="$fullUrl(o['cover'])" />
													...
													<view v-if="0 && $check_field('get','course_type')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>课程类型</span>
                          </view>
								...
								<text>
									{{ o["course_type"] }}
													...
													<view v-if="1 && $check_field('get','class_time')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>上课时间</span>
                          </view>
								...
								<text>
									{{ o["class_time"] }}
													...
													<view v-if="1 && $check_field('get','class_location')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>上课地点</span>
                          </view>
								...
								<text>
									{{ o["class_location"] }}
													...
													<view v-if="0 && $check_field('get','teacher_user')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>教师用户</span>
                          </view>
								...
								<text>
									{{ get_user_teacher_user(o['teacher_user']) }}
													...
													<view v-if="0 && $check_field('get','teacher_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>教师姓名</span>
                          </view>
                            ...
                            <span>学生姓名</span>
								...
								<text>
									{{ o["student_name"] }}
													...
													<view v-if="0 && $check_field('get','confirm_the_number_of_people')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>确认人数</span>
                          </view>
											<view class="diy_field diy_text text">
								<text>
									{{ o["confirm_the_number_of_people"] }}
								</text>
							</view>
										</view>
					</view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/course_schedule/table','del') || $check_action('/course_schedule/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/course_schedule/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/course_schedule/table','set') || $check_action('/course_schedule/view','set') || $check_action('/course_schedule/view','get')" class="btn btn-primary">详情</navigator>
	    					</view>
				</view>
			</view>
		</view>
		...
		data() {
			return {
                ...
                list_user_student_users: [],
                                // 确认人数列表
                list_confirm_the_number_of_people: [{value:"",text:"全部"}],
        			}
		},
		methods: {
          search() {
