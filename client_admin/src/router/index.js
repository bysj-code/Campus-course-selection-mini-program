...
const routes = [
	...
	// 选课课表路由
	{
		path: '/course_schedule/table',
		name: 'course_schedule_table',
		component: () => import('../views/course_schedule/table.vue')
	},
	{
		path: '/course_schedule/view',
		name: 'course_schedule_view',
		component: () => import('../views/course_schedule/view.vue')
	},
