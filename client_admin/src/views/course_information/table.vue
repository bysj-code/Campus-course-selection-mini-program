<template>
	<el-main class="bg table_wrap">
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row>
					...
					<el-form-item label="课程类型">
									<el-select v-model="query.course_type">
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/course_information/table','set') || $check_action('/course_information/view','set') || $check_action('/course_information/view','get') || $check_action('/确认选课/table','add') || $check_action('/确认选课/view','add')" >
