        ...
        <view>
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','department_information') || $check_field('add','department_information') || $check_field('set','department_information')" label="院系信息" name="department_information">
                                <uni-easyinput type="text" v-model="form['department_information']" v-if="user_group === '管理员' || (form['student_users_id'] && $check_field('set','department_information')) || (!form['student_users_id'] && $check_field('add','department_information'))" :disabled="disabledObj['department_information_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','department_information')">
                  {{ form['department_information'] }}
                </text>
                            </uni-forms-item>
              <uni-forms-item v-if="$check_field('get','class_information') || $check_field('add','class_information') || $check_field('set','class_information')" label="班级信息" name="class_information">
                                <uni-easyinput type="text" v-model="form['class_information']" v-if="user_group === '管理员' || (form['student_users_id'] && $check_field('set','class_information')) || (!form['student_users_id'] && $check_field('add','class_information'))" :disabled="disabledObj['class_information_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','class_information')">
                  {{ form['class_information'] }}
                </text>
                            </uni-forms-item>
      ...
      form: {
          ...
          disabledObj:{
                        "student_name_isDisabled": false,
                                ...
                                "class_information_isDisabled": false,
                                  },
                                          // 性别选项列表
          list_gender: [],
                                                                              }
