<template>
  <view class="page_course_information diy_table diy_table_tml" id="course_information_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                    <uni-forms-item label="课程名称" name="course_name">
                      <uni-easyinput type="text" v-model="query.course_name" placeholder="课程名称" />
                    </uni-forms-item>
                      <uni-forms-item label="课程类型" name="course_type">
                  <uni-data-select placeholder="请选择"
            v-model="query['course_type']"
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/course_information/view?" v-show="user_group == '管理员' || $check_action('/course_information/table','add') || $check_action('/course_information/view','add')">添加</navigator>
	...
	<view class="warp" >
		<view class="container">
			<view v-for="(o,i) in list" class="row box_style">
									<view class="col" v-if="0 && $check_field('get','course_no')">
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','course_name')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>课程名称</span>
							</view>
						...
						<view class="view">
							<view class="diy_title" v-if=" false">
								<span>封面</span>
									...
									<view class="col" v-if="1 && $check_field('get','course_type')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>课程类型</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','class_time')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>上课时间</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','class_location')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>上课地点</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','number_of_people_remaining')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>剩余人数</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','teacher_user')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>教师用户</span>
							</view>
								...
								<span>
									{{ get_user_teacher_user(o['teacher_user']) }}
								</span>
								</view>
													</view>
					</view>
									<view class="col" v-if="0 && $check_field('get','teacher_name')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>教师姓名</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','course_introduction')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>课程介绍</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/course_information/table','del') || $check_action('/course_information/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/course_information/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/course_information/table','set') || $check_action('/course_information/view','set') || $check_action('/course_information/view','get')" class="btn btn-primary">详情</navigator>
																							<!--跨表按钮-->
															<a type="button" size="mini" class="btn btn-primary" v-if="$check_action('/course_schedule/view','add')" @click="to_form('/pages/course_schedule/view',o)">
									<span>确认选课</span>
								</a>
																						</view>
			</view>
	...
	export default {
		...
		data() {
			return {
				...
				list: [],
                                            // 课程类型列表
                list_course_type: [{value:"",text:"全部"}],
                                                                // 用户列表
