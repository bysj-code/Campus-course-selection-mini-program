		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="院系信息" prop="department_information">
												<el-input id="department_information" v-model="form_sub['department_information']" placeholder="请输入院系信息"
							  v-if="user_group === '管理员' || (form_sub['student_users_id'] && $check_field('set','department_information')) || (!form_sub['student_users_id'] && $check_field('add','department_information'))"></el-input>
					<div v-else-if="$check_field('get','department_information')">{{form_sub['department_information']}}</div>
											</el-form-item>
			</el-col>
								<el-col v-if="user_group === '管理员' || $check_field('get','class_information') || $check_field('add','class_information') || $check_field('set','class_information')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="班级信息" prop="class_information">
												<el-input id="class_information" v-model="form_sub['class_information']" placeholder="请输入班级信息"
							  v-if="user_group === '管理员' || (form_sub['student_users_id'] && $check_field('set','class_information')) || (!form_sub['student_users_id'] && $check_field('add','class_information'))"></el-input>
					<div v-else-if="$check_field('get','class_information')">{{form_sub['class_information']}}</div>
											</el-form-item>
			</el-col>
