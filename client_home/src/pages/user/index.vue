						...
						<view class="">
							<view  class="list_module">
									...
									<navigator class="my_module" url="/pages/student_users/table" hover-class="hover">
										...
										<view v-if="user_group != '管理员' && $check_action('/teacher_user/table','get')">
									<navigator class="my_module" url="/pages/teacher_user/table" hover-class="hover">
										<div>
											<text>教师用户</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/course_information/table','get')">
									<navigator class="my_module" url="/pages/course_information/table" hover-class="hover">
										<div>
											<text>课程信息</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/course_type/table','get')">
									<navigator class="my_module" url="/pages/course_type/table" hover-class="hover">
										<div>
											<text>课程类型</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/course_schedule/table','get')">
									<navigator class="my_module" url="/pages/course_schedule/table" hover-class="hover">
										<div>
											<text>选课课表</text>
											<span>></span>
										</div>
