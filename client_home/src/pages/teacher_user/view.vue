          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','teacher_name') || $check_field('add','teacher_name') || $check_field('set','teacher_name')" label="教师姓名" name="teacher_name">
                                <uni-easyinput type="text" v-model="form['teacher_name']" v-if="user_group === '管理员' || (form['teacher_user_id'] && $check_field('set','teacher_name')) || (!form['teacher_user_id'] && $check_field('add','teacher_name'))" :disabled="disabledObj['teacher_name_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','teacher_name')">
                  {{ form['teacher_name'] }}
                </text>
                            </uni-forms-item>
              <uni-forms-item v-if="$check_field('get','gender_of_teachers') || $check_field('add','gender_of_teachers') || $check_field('set','gender_of_teachers')" label="教师性别" name="gender_of_teachers">
                        <uni-data-select
                  v-model="form.gender_of_teachers"
                  :localdata="list_gender_of_teachers"
                  :clear="!disabledObj['gender_of_teachers_isDisabled']"
                  :disabled="disabledObj['gender_of_teachers_isDisabled']"
                  v-if="user_group === '管理员' || (form['teacher_user_id'] && $check_field('set','gender_of_teachers')) || (!form['teacher_user_id'] && $check_field('add','gender_of_teachers'))"
                ></uni-data-select>
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','gender_of_teachers')">
                  {{ form['gender_of_teachers'] }}
                </text>
                    </uni-forms-item>
...
export default {
  ...
  data() {
    return {
      ...
      url_get_obj: "~/api/teacher_user/get_obj?",
      ...
      uni.chooseFile({
        ...
        success: function(res) {
          ...
          const uploadTask = uni.uploadFile({
            url: _self.$fullUrl('/api/teacher_user/upload?'),
